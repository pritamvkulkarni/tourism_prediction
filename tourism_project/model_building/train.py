...
Xtrain_path = "hf://datasets/pkulkar/tourism-prediction/Xtrain.csv"
Xtest_path = "hf://datasets/pkulkar/tourism-prediction/Xtest.csv"
ytrain_path = "hf://datasets/pkulkar/tourism-prediction/ytrain.csv"
ytest_path = "hf://datasets/pkulkar/tourism-prediction/ytest.csv"
...
# Updated feature lists based on the tourism.csv dataset
numeric_features = [
    'Age',
    'CityTier',
...
# Adjusted param_grid to include preprocessor step name in parameter names
param_grid = {
